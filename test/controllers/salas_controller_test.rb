...
class SalasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sala" do
    assert_difference('Sala.count') do
      post salas_url, params: { sala: { cinema_id: @sala.cinema_id, filme_id: @sala.filme_id, lingua: @sala.lingua, nome: @sala.nome, tipo: @sala.tipo } }
    end
  ...
  test "should update sala" do
    patch sala_url(@sala), params: { sala: { cinema_id: @sala.cinema_id, filme_id: @sala.filme_id, lingua: @sala.lingua, nome: @sala.nome, tipo: @sala.tipo } }
