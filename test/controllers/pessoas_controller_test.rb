...
class PessoasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post pessoas_url, params: { pessoa: { nome: @pessoa.nome, url_foto: @pessoa.url_foto } }
    end
  ...
  test "should update pessoa" do
    patch pessoa_url(@pessoa), params: { pessoa: { nome: @pessoa.nome, url_foto: @pessoa.url_foto } }
